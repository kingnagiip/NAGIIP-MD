...
const ownerNumber = ['252638697036']
...
console.log("CONNECTING NAGIIP-MD 🧬...");
...
console.log('NAGIIP-MD CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ NAGIIP-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ your name ✅*
...
if(senderNumber.includes("252638697036")){
if(isReact) return
m.react("🦋")
   }
...
app.get("/", (req, res) => {
res.send("HEY, NAGIIP-MD STARTED ✅");
});
